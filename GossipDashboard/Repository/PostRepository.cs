            ...
            foreach (var item in tempPost)
            {
                ...
                if (isExist == null && item.Subject1.Trim().Length > 3 && (item.ContentPost1_1.Trim().Length > 3 || item.ContentPost1_2.Trim().Length > 3 || item.ContentPost1_3.Trim().Length > 3 || item.ContentPost1_4.Trim().Length > 3 || item.ContentPost1_2.Trim().Length > 5 || item.ContentPost1_6.Trim().Length > 3 || item.ContentPost1_7.Trim().Length > 3))
                {
                    ...
                    var entityPost = context.Posts.Add(new Post()
                    {
                        ...
                        SubSubject1_1 = item.SubSubject1_1,
                        SubSubject1_2 = item.SubSubject1_2,
                        ContentPost1_1 = item.ContentPost1_1,
                        ContentPost1_2 = item.ContentPost1_2,
                        ContentPost1_3 = item.ContentPost1_3,
                        ContentPost1_4 = item.ContentPost1_4,
                        ContentPost1_5 = item.ContentPost1_5,
                        Image1_1 = item.Image1_1,
                        Image1_2 = item.Image1_2,
                        Image1_3 = item.Image1_3,
                        Subject2 = item.Subject2,
                        SubSubject2_1 = item.SubSubject2_1,
                        SubSubject2_2 = item.SubSubject2_2,
                        ContentPost2_1 = item.ContentPost2_1,
                        ContentPost2_2 = item.ContentPost2_2,
                        ContentPost2_3 = item.ContentPost2_3,
                        ContentPost2_4 = item.ContentPost2_4,
                        ContentPost2_5 = item.ContentPost2_5,
                        Image2_1 = item.Image2_1,
                        Image2_2 = item.Image2_2,
                        Image2_3 = item.Image2_3,
                        Subject3 = item.Subject3,
                        SubSubject3_1 = item.SubSubject3_1,
                        SubSubject3_2 = item.SubSubject3_2,
                        ContentPost3_1 = item.ContentPost3_1,
                        ContentPost3_2 = item.ContentPost3_2,
                        ContentPost3_3 = item.ContentPost3_3,
                        ContentPost3_4 = item.ContentPost3_4,
                        ContentPost3_5 = item.ContentPost3_5,
                        Image3_1 = item.Image3_1,
                        Image3_2 = item.Image3_2,
                        Image3_3 = item.Image3_3,
                        Subject4 = item.Subject4,
                        SubSubject4_1 = item.SubSubject4_1,
                        SubSubject4_2 = item.SubSubject4_2,
                        ContentPost4_1 = item.ContentPost4_1,
                        ContentPost4_2 = item.ContentPost4_2,
                        ContentPost4_3 = item.ContentPost4_3,
                        ContentPost4_4 = item.ContentPost4_4,
                        ContentPost4_5 = item.ContentPost4_5,
                        Image4_1 = item.Image4_1,
                        Image4_2 = item.Image4_2,
                        Image4_3 = item.Image4_3,
                        Subject5 = item.Subject5,
                        SubSubject5_1 = item.SubSubject5_1,
                        SubSubject5_2 = item.SubSubject5_2,
                        ContentPost5_1 = item.ContentPost5_1,
                        ContentPost5_2 = item.ContentPost5_2,
                        ContentPost5_3 = item.ContentPost5_3,
                        ContentPost5_4 = item.ContentPost5_4,
                        ContentPost5_5 = item.ContentPost5_5,
                        Image5_1 = item.Image5_1,
                        Image5_2 = item.Image5_2,
                        Image5_3 = item.Image5_3,
                        Subject6 = item.Subject6,
                        SubSubject6_1 = item.SubSubject6_1,
                        SubSubject6_2 = item.SubSubject6_2,
                        ContentPost6_1 = item.ContentPost6_1,
                        ContentPost6_2 = item.ContentPost6_2,
                        ContentPost6_3 = item.ContentPost6_3,
                        ContentPost6_4 = item.ContentPost6_4,
                        ContentPost6_5 = item.ContentPost6_5,
                        Image6_1 = item.Image6_1,
                        Image6_2 = item.Image6_2,
                        Image6_3 = item.Image6_3,
                        Subject7 = item.Subject7,
                        SubSubject7_1 = item.SubSubject7_1,
                        SubSubject7_2 = item.SubSubject7_2,
                        ContentPost7_1 = item.ContentPost7_1,
                        ContentPost7_2 = item.ContentPost7_2,
                        ContentPost7_3 = item.ContentPost7_3,
                        ContentPost7_4 = item.ContentPost7_3,
                        ContentPost7_5 = item.ContentPost7_5,
                        Image7_1 = item.Image7_1,
                        Image7_2 = item.Image7_2,
                        Image7_3 = item.Image7_3,
                        Subject8 = item.Subject8,
                        SubSubject8_1 = item.SubSubject8_1,
                        SubSubject8_2 = item.SubSubject8_2,
                        ContentPost8_1 = item.ContentPost8_1,
                        ContentPost8_2 = item.ContentPost8_2,
                        ContentPost8_3 = item.ContentPost8_3,
                        ContentPost8_4 = item.ContentPost8_4,
                        ContentPost8_5 = item.ContentPost8_5,
                        Image8_1 = item.Image8_1,
                        Image8_2 = item.Image8_2,
                        Image8_3 = item.Image8_3,
                        Subject9 = item.Subject9,
                        SubSubject9_1 = item.SubSubject9_1,
                        SubSubject9_2 = item.SubSubject9_2,
                        ContentPost9_1 = item.ContentPost9_1,
                        ContentPost9_2 = item.ContentPost9_2,
                        ContentPost9_3 = item.ContentPost9_3,
                        ContentPost9_4 = item.ContentPost9_4,
                        ContentPost9_5 = item.ContentPost9_5,
                        Image9_1 = item.Image9_1,
                        Image9_2 = item.Image9_2,
                        Image9_3 = item.Image9_3,
                        Subject10 = item.Subject10,
                        SubSubject10_1 = item.SubSubject10_1,
                        SubSubject10_2 = item.SubSubject10_2,
                        ContentPost10_1 = item.ContentPost10_1,
                        ContentPost10_2 = item.ContentPost10_2,
                        ContentPost10_3 = item.ContentPost10_3,
                        ContentPost10_4 = item.ContentPost10_4,
                        ContentPost10_5 = item.ContentPost10_5,
                        Image10_1 = item.Image10_1,
                        Image10_2 = item.Image10_2,
                        Image10_3 = item.Image10_3,
                        Subject11 = item.Subject11,
                        SubSubject11_1 = item.SubSubject11_1,
                        SubSubject11_2 = item.SubSubject11_2,
                        ContentPost11_1 = item.ContentPost11_1,
                        ContentPost11_2 = item.ContentPost11_2,
                        ContentPost11_3 = item.ContentPost11_3,
                        ContentPost11_4 = item.ContentPost11_4,
                        ContentPost11_5 = item.ContentPost11_5,
                        Image11_1 = item.Image11_1,
                        Image11_2 = item.Image11_2,
                        Image11_3 = item.Image11_3,
                        Subject12 = item.Subject12,
                        SubSubject12_1 = item.SubSubject12_1,
                        SubSubject12_2 = item.SubSubject12_2,
                        ContentPost12_1 = item.ContentPost12_1,
                        ContentPost12_2 = item.ContentPost12_2,
                        ContentPost12_3 = item.ContentPost12_3,
                        ContentPost12_4 = item.ContentPost12_4,
                        ContentPost12_5 = item.ContentPost12_5,
                        Image12_1 = item.Image12_1,
                        Image12_2 = item.Image12_2,
                        Image12_3 = item.Image12_3,
                        Subject13 = item.Subject13,
                        SubSubject13_1 = item.SubSubject13_1,
                        SubSubject13_2 = item.SubSubject13_2,
                        ContentPost13_1 = item.ContentPost13_1,
                        ContentPost13_2 = item.ContentPost13_2,
                        ContentPost13_3 = item.ContentPost13_3,
                        ContentPost13_4 = item.ContentPost13_4,
                        ContentPost13_5 = item.ContentPost13_5,
                        Image13_1 = item.Image13_1,
                        Image13_2 = item.Image13_2,
                        Image13_3 = item.Image13_3,
                        Subject14 = item.Subject14,
                        SubSubject14_1 = item.SubSubject14_1,
                        SubSubject14_2 = item.SubSubject14_2,
                        ContentPost14_1 = item.ContentPost14_1,
                        ContentPost14_2 = item.ContentPost14_2,
                        ContentPost14_3 = item.ContentPost14_3,
                        ContentPost14_4 = item.ContentPost14_4,
                        ContentPost14_5 = item.ContentPost14_5,
                        Image14_1 = item.Image14_1,
                        Image14_2 = item.Image14_2,
                        Image14_3 = item.Image14_3,
                        Subject15 = item.Subject15,
                        SubSubject15_1 = item.SubSubject15_1,
                        SubSubject15_2 = item.SubSubject15_2,
                        ContentPost15_1 = item.ContentPost15_1,
                        ContentPost15_2 = item.ContentPost15_2,
                        ContentPost15_3 = item.ContentPost15_3,
                        ContentPost15_4 = item.ContentPost15_4,
                        ContentPost15_5 = item.ContentPost15_5,
                        Image15_1 = item.Image15_1,
                        Image15_2 = item.Image15_2,
                        Image15_3 = item.Image15_3,
                        Subject16 = item.Subject16,
                        SubSubject16_1 = item.SubSubject16_1,
                        SubSubject16_2 = item.SubSubject16_2,
                        ContentPost16_1 = item.ContentPost16_1,
                        ContentPost16_2 = item.ContentPost16_2,
                        ContentPost16_3 = item.ContentPost16_3,
                        ContentPost16_4 = item.ContentPost16_4,
                        ContentPost16_5 = item.ContentPost16_5,
                        Image16_1 = item.Image16_1,
                        Image16_2 = item.Image16_2,
                        Image16_3 = item.Image16_3,
                        Subject17 = item.Subject17,
                        SubSubject17_1 = item.SubSubject17_1,
                        SubSubject17_2 = item.SubSubject17_2,
                        ContentPost17_1 = item.ContentPost17_1,
                        ContentPost17_2 = item.ContentPost17_2,
                        ContentPost17_3 = item.ContentPost17_3,
                        ContentPost17_4 = item.ContentPost17_4,
                        ContentPost17_5 = item.ContentPost17_5,
                        Image17_1 = item.Image17_1,
                        Image17_2 = item.Image17_2,
                        Image17_3 = item.Image17_3,
                        Subject18 = item.Subject18,
                        SubSubject18_1 = item.SubSubject18_1,
                        SubSubject18_2 = item.SubSubject18_2,
                        ContentPost18_1 = item.ContentPost18_1,
                        ContentPost18_2 = item.ContentPost18_2,
                        ContentPost18_3 = item.ContentPost18_3,
                        ContentPost18_4 = item.ContentPost18_4,
                        ContentPost18_5 = item.ContentPost18_5,
                        Image18_1 = item.Image18_1,
                        Image18_2 = item.Image18_2,
                        Image18_3 = item.Image18_3,
                        Subject19 = item.Subject19,
                        SubSubject19_1 = item.SubSubject19_1,
                        SubSubject19_2 = item.SubSubject19_2,
                        ContentPost19_1 = item.ContentPost19_1,
                        ContentPost19_2 = item.ContentPost19_2,
                        ContentPost19_3 = item.ContentPost19_3,
                        ContentPost19_4 = item.ContentPost19_4,
                        ContentPost19_5 = item.ContentPost19_5,
                        Image19_1 = item.Image19_1,
                        Image19_2 = item.Image19_2,
                        Image19_3 = item.Image19_3,
                        Subject20 = item.Subject20,
                        SubSubject20_1 = item.SubSubject20_1,
                        SubSubject20_2 = item.SubSubject20_2,
                        ContentPost20_1 = item.ContentPost20_1,
                        ContentPost20_2 = item.ContentPost20_2,
                        ContentPost20_3 = item.ContentPost20_3,
                        ContentPost20_4 = item.ContentPost20_4,
                        ContentPost20_5 = item.ContentPost20_5,
                        Image20_1 = item.Image20_1,
                        Image20_2 = item.Image20_2,
                        Image20_3 = item.Image20_3,
                        ...
                        IsCreatedPost = item.IsCreatedPost,
                        Cat1 = item.Cat1,
                        Cat2 = item.Cat2,
                        Cat3 = item.Cat3,
                        Tag1 = item.Tag1,
                        ...
                        ContentPost1_6 = item.ContentPost1_6,
                        ContentPost1_7 = item.ContentPost1_7,
                    });
                    context.SaveChanges();
